globalThis.TB_CONSTANTS = Object.freeze({
  ...
  GEMINI_MODELS: [
    ...
    { value: "gemma-3-27b-it", label: "Gemma 3 27B IT (RPM 15, RPD 31)", default: true },
    { value: "gemma-3-12b-it", label: "Gemma 3 12B IT (RPM 30)" },
    { value: "gemini-3.1-flash-lite-preview", label: "Gemini 3.1 Flash Lite (RPM 17)" },
    { value: "gemini-flash-lite-latest", label: "Gemini Flash Lite Latest (Stable)" }
  ],

  CEREBRAS_MODELS: [
    { value: "llama3.1-8b", label: "Llama 3.1 8B (Fastest & Stable)", default: true },
    { value: "qwen-3-235b-instruct-2507", label: "Qwen 3 235B (Smartest & High Quota)" },
    { value: "gpt-oss-120b", label: "GPT OSS 120B (High Quality)" },
...
4. TUYỆT ĐỐI KHÔNG DỊCH HOẶC THAY ĐỔI các mã [[TB_IMG:id]] và !image.png!.
...
7. GIỮ NGUYÊN các khối code (mã lệnh) nằm trong các dấu backticks (\`\`\` hoặc \`).
